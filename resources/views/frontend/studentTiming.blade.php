...
@section('content')
        ...
        <div class="container-xxl py-5 page-header position-relative mb-5">
            <div class="container py-5">
                <h1 class="display-2 text-white animated slideInDown mb-4">Timing</h1>
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('index')}}">Home</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Timing</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-12 wow  fadeInUp" data-wow-delay="0.1s">
                        <h1 class="mb-4 text-center">Timing</h1>
                        <div class="row">
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-junior" role="tabpanel" aria-labelledby="pills-junior-tab" tabindex="0">
                                            <table class="table table-info table-bordered">
                                                <tr class="table-info">
                                                    <th>Timings Summer and Winter</th>
                                                    <td>8:00 am to 1:45 pm</td>
                                                </tr>
                                            </table>
                                        </div>
